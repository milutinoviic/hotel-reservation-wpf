...
namespace HotelReservation.Repository
{
    ...
    public class RoomRepository : IRoomRepository
    {
        ...
        {
            return $"{room.Id},{room.RoomNumber},{room.HasTV},{room.HasMiniBar},{room.RoomType.Id}, {room.IsActive}"; //sta mi sve upisuje u fajl
        }

        private Room FromCSV(string csv)  //ovde cita iz fajla
        {
